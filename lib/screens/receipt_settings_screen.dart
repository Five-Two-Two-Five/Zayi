      ...
      children: [
        ..._predefinedTaxes.asMap().entries.map((entry) {
          ...
          return Padding(
            ...
            child: Row(
              children: [
                Expanded(child: TextFormField(decoration: const InputDecoration(labelText: 'Label'), initialValue: tax['label'], onChanged: (v) => _predefinedTaxes[idx]['label'] = v)),
                const SizedBox(width: 8),
                Expanded(child: TextFormField(decoration: const InputDecoration(labelText: 'Rate %'), initialValue: tax['rate'].toString(), onChanged: (v) => _predefinedTaxes[idx]['rate'] = double.tryParse(v) ?? 0.0)),
